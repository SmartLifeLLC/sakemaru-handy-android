...
| 3 | GET | `/api/incoming/schedules` | 入荷予定一覧取得（商品リスト） |
| 4 | GET | `/api/incoming/schedules/{id}` | 入荷予定詳細取得 |
...
### P13: 入荷入力画面 (IncomingInputScreen)
...
│ │ 商品名AAAA                      │ │
│ │ 酒丸本社                        │ │
│ │ 予定:02/19  入荷:02/19 [完了] 80│ │
│ └──────────────────────────────────┘ │
│ ┌──────────────────────────────────┐ │
│ │ JAN: 4901234567891  Code: 10002 │ │
│ │ 商品名BBBB                      │ │
│ │ 酒丸第二倉庫                    │ │
│ │ 予定:02/19  入荷:02/19 [作業中] 50│
│ └──────────────────────────────────┘ │
│                                      │
├──────────────────────────────────────┤
│ [F1:---] [F2:戻る] [F3:リスト] [F4:---] │
