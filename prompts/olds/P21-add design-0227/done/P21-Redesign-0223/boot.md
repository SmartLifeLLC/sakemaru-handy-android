...
P21（出荷データ入力画面 = OutboundPickingScreen）のUIリデザイン。
...
- 実績:
  ...
  - ヘッダー: クリーム背景 (#FDFBF2)、📦アイコン (#E67E22)、「出荷」タイトル (#C0392B 太字18sp)
  ...
  - QuantityInputCard: OutlinedCard オレンジ枠2dp、受注数グレー読取専用、出荷数オレンジ強調入力
